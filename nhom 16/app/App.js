  ...
  return (
    <DrawerContentScrollView {...props}>
      <View style={{ marginTop: -5 }}>
        <Image source={anh} style={{ height: 200 }} />
      </View>
      <View style={{ borderBottomColor: '#D8D8D8', borderBottomWidth: 4 }}>
        <DrawerItem
          ...
          icon={() => (
            <Icon name="home" style={{ fontSize: 35, color: '#A4A4A4' }} />
          )}
        />
        <DrawerItem
          label="Học lí thuyết"
          ...
          icon={() => (
            <Icon name="circle" style={{ fontSize: 35, color: '#A4A4A4' }} />
          )}
        />
        <DrawerItem
          style={{ marginTop: -3 }}
          ...
          icon={() => (
            <Icon name="book" style={{ fontSize: 35, color: '#A4A4A4' }} />
          )}
        />
      ...
      <DrawerItem
        ...
        onPress={() => props.navigation.navigate('Lithuyet')}
        icon={() => (
          <Icon name="comment-account-outline" style={{ fontSize: 35 }} />
        )}
      />
      <DrawerItem
...
function Mystack({ navigation }) {
  return (
    <Stack.Navigator
      initialRouteName="Thi thử bằng lái xe a1"
      screenOptions={{
