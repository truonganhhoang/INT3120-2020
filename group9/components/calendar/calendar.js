...
import { Text, View, Dimensions, TouchableOpacity, Alert, StyleSheet, RefreshControl } from 'react-native';
  ...
  return (
    <TouchableOpacity
      onPress={async () => {
        await this.setState(
          { emptyDate },
          console.log(this.state.emptyDate),
        );
        console.log(foo, emptyDate, this.state.emptyDate);
      }}
    >
      <Text style={{ color: 'gray', paddingBottom: 4 }}>
        {emptyDate}
      </Text>
