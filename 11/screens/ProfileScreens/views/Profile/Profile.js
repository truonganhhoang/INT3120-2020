            ...
            <View style={{
                ...
                <ScrollView style={{ height: 2 * heightScreen / 3 }}>
                    <View style={{ height: heightScreen / 5, flexDirection: 'row', alignItems: 'center' }}>
                        <BodyProfile titletext="Tên đăng nhập" bodytext='maithedai' url={require('../../assets/images/tendangnhap.jpg')} navigation={this.props.navigation} nameScreen='Main'/>
                    </View>
                    <View style={{ height: heightScreen / 5, flexDirection: 'row', alignItems: 'center' }}>
                        <BodyProfile  titletext="Email" bodytext='maithedai@gmail.com' url={require('../../assets/images/email.png')} navigation={this.props.navigation} nameScreen='Main'/>
                    </View>
                    <View style={{ height: heightScreen / 5, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ height: heightScreen / 5, flexDirection: 'row', alignItems: 'center' }}>
                        <BodyProfile  titletext="Chia sẻ khóa học" bodytext='maithedai' url={require('../../assets/images/share.png')} navigation={this.props.navigation} nameScreen='Main'/>
                    </View>
                    <View style={{ height: heightScreen / 5, flexDirection: 'row', alignItems: 'center' }}>
