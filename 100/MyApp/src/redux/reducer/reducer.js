const defaultState ={
    courses: [
    {id: 1, idAuthor:1, date:"30/04/2020", price:200, name: "React/Redux cơ bản", image:require("../../img/002.png"), beta: "Redux là một predictable state management tool cho các ứng dụng Javascript. Nó giúp bạn viết các ứng dụng hoạt động một cách nhất quán.", onMark: true, hot: false},
    {id: 2, idAuthor:2, date:"29/04/2020", price:150, name: "Godot engine cơ bản", image:require("../../img/godot.png"), beta: "Godot là một công cụ trò chơi mã nguồn mở, 2D và 3D, đa nền tảng, miễn phí và được phát hành theo giấy phép MIT.", onMark: false, hot: true},
    {id: 3, idAuthor:7, date:"12/05/2020", price:240, name: "Game 2D platform", image:require("../../img/game.png"), beta: "Trò chơi platform, hoặc trò chơi nền tảng, là một thể loại trò chơi video và thể loại phụ của trò chơi hành động.", onMark: true, hot: false},
