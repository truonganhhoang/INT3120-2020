  ...
  <ScrollView>
      ...
      <TouchableOpacity
        ...
        <View style={styles.stt}>
          ...
          <Text style={styles.textContent}>
            Vì sao xuất hiện cầu vồng trên bầu trời?
          </Text>
        </View>
      </TouchableOpacity>
      <View style={styles.hr} />
      <TouchableOpacity
        ...
        <View style={styles.stt}>
          ...
          <Text style={styles.textContent}>
            Khí tượng, thời tiết và khí hậu có gì khác nhau?
          </Text>
        </View>
      </TouchableOpacity>
      <View style={styles.hr} />
      <TouchableOpacity
        ...
        <View style={styles.stt}>
          ...
          <Text style={styles.textContent}>
            Trong một ngày không khí lúc nào trong lành nhất
          </Text>
        </View>
      </TouchableOpacity>
      <View style={styles.hr} />
