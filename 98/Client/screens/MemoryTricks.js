    ...
    return (
        <View style={styles.container}>
            ...
            <Modal animationType='fade' transparent={true} visible={route.params.modalVisible} >
                <TouchableOpacity onPress={ () => navigation.setParams({ modalVisible: false }) } style={{ flex: 1 }} >
                    <TouchableWithoutFeedback>
                        <View style={{ height: 500, width: 225, alignSelf: 'flex-end', backgroundColor: '#fff' }} >
                            <View style={{ height: 390, width: 225, backgroundColor: '#fff', alignSelf: 'flex-end', marginTop: 60, paddingHorizontal: 15, paddingVertical: 10, elevation: 15 }}>
                                <FlatList
                                    data={modalData}
                                    renderItem={ ({ item }) => (
                                        <TouchableOpacity onPress={ () => {
