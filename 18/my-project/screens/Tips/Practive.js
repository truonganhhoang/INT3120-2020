...
var dataPractive = [
  {
    ...
    name: 'Giới thiệu',
    content:
      '(Hệ thống cảm biến điện tử trên sản sát hạch tại Trung tâm sát hạch sẽ thực hiện châm biếm, nêu không bị lồi thì điểm tối đa là 100 điếm Điếm đậu là từ 80 điểm trở lên).\n\nTổng thời gian toàn bộ bài thi là 15 phút, thời gian mỗi bài thi sẽ được tính từ khi vào bài thi (vạch màu trang trên đường) đến khi ra khỏi bài thi ',
  },
  {
    key: '2',
