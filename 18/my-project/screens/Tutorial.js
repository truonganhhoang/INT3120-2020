    ...
    return (
      ...
      >
        ...
        <Text style={{ paddingBottom: 20 }}>
          ...
          biển bảo chỉ dẫn, biển báo nguy hiểm..
        </Text>
        <Text style={{ paddingBottom: 20 }}>
          2. Ngày thứ 2 bạn hãy vào phần học 450 câu lý thuyết, học đi học lại
          các câu lý thuyết này và các mẹo làm của từng câu, nhớ các định nghĩa
          cơ bản như nồng độ cồn, tốc độ cho phép..và học mẹo làm bài các câu
          hỏi sa hình..
        </Text>
        <Text style={{ paddingBottom: 20 }}>
          3. Ngày thứ 3 bạn hãy vào làm hết các bộ đề thi của từng hạng bằng lái
          xe. Sau khi làm xong tất cả các đề mặc định (đều đạt > 28 câu trở
          lên). Bạn hãy trọn 1 đề xáo trộn và làm đến khi nào điểm thi của bạn
          đều đạt thì chúc mừng bạn đã hoàn thành quá trình ôn luyện
        </Text>
        <Text style={{ paddingBottom: 20 }}>
          4. Nếu bạn đã hoàn thành 3 bước trên, thì bạn chỉ cần giữ tự tin và
          bình tĩnh khi thi, chắc chắn bạn sẽ đạt kết quả cao.Chúc bạn thi đỗ
          với số điểm tối đa
        </Text>
        <TouchableHighlight
          style={styles.submit}
