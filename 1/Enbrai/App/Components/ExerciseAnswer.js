    ...
    return (
      <View>
        ...
        <View style={{ paddingLeft: 20, paddingRight: 10, paddingBottom: 15, paddingTop: 10}}>
          <Text style={{fontSize: 18, color: '#424242', marginBottom: 10}}>Bạn cần hoàn thành từ <Text style={{fontWeight: 'bold'}}>{props.questCount-props.questCompleteCount}</Text> nữa để mở khóa <Text style={{fontWeight: 'bold'}}>level {props.levelIndex}</Text></Text>
          <ProgressBarAndroid
