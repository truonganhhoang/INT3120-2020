...
const ChooseEngFromVieWordItem = (props) => {
  ...
  const checkAnswer = (item, index) => {
    setIsPressed(true)
    var answerIndex = props.meaningList.indexOf(props.question.word)
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 8, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          <Text style={{ fontSize: 30, color: '#009dd6', fontWeight: 'bold' }}>{props.question.meaning}</Text>
        </View>
...
export default ChooseEngFromVieWordItem