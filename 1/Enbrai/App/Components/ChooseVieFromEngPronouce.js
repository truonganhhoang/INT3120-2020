...
import ChooseVieFromEngPronouceItem from './ChooseVieFromEngPronouceItem'
import { firebaseAd, Banner, UNIT_ID_BANNER } from './FirbaseAd'

const ChooseVieFromEngPronouce = (props) => {
...
export default ChooseVieFromEngPronouce