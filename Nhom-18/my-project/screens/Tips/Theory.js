...
// import dataTheory from 'D:/Github/INT3120-2020/Nhom-18/my-project/data/dataTheory.js'
...
//                         data={dataTheory}
//                         renderItem={({ item }) =>
//                             <List.Accordion style={{backgroundColor:'#fff', marginHorizontal:10, marginVertical:5, padding:5}}
//                             titleStyle={{fontSize:13, fontWeight: 'bold',}}
//                                 title={item.name}
//                                 // left={props => <List.Icon {...props} icon="folder" />}
//                             >
//                                 <List.Item style={{}} title={item.content} />
//                             </List.Accordion>
//                         }
//                     />
//                 </List.Section>
